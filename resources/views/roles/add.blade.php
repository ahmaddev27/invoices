@extends('layouts.master',['title'=>'اضافة صلاحية '])
@push('css')
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('roles.store')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <table id="" class="table key-buttons text-md-nowrap" data-page-length='50'
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn btn-success-gradient"><i class="fa fa-plus-circle"> حفظ البيانات </i></button>
                        </div>
